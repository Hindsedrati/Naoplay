        ...
        <article id='p2' className='contact__mobile contact__content__child'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='contact__mobile__box'>
              <input className='contact__input' type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Nom" />
              <label htmlFor="name"></label>

              <input className='contact__input' type="text" id="company" value={company} onChange={(e) => setCompany(e.target.value)} placeholder="Société" />
              <label htmlFor="company"></label>

              <input className='contact__input' type="tel" id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Téléphone" />
              <label htmlFor="phone"></label>

              <input className='contact__input' type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Mail" />
              <label htmlFor="email"></label>

              <input className='contact__input' className='contact__message' type="message" id="message" value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Votre message"></input>
