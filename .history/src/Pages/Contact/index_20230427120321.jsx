        ...
        <article id='p2' className='contact__mobile contact__content__child'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='contact__mobile__box'>
              ...
              <input className='contact__input contact__message' type="message" id="message" value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Votre message"></input>
