    ...
    <section id="contact" className='contact'>
      ...
      <div className='contact__content'>
        ...
        <article id='p2' className='contact__mobile contact__content__child'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='contact__mobile__box'>
              ...
              <button onClick={() => {window.location.href = '/Error'}} className='contact__btn' type="submit">Envoyer</button>
            </div>
        ...
        <form className='contact__desktop__form' onSubmit={handleSubmit}>
          ...
          <button onClick={() => {window.location.href = '/Error403'}} className='contact__btn' type="submit">Envoyer</button>
